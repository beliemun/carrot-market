  ...
  return (
    <div className={className}>
      <div className="col-cetner">
        <div>
          <div className="fixed top-0 left-0 w-full bg-white row-center border-b border-gray-200 h-12 justify-between px-4">
            {canGoBack ? (
        ...
        {hasTabBar ? (
          <nav className="fixed row-center justify-around bottom-0 w-full bg-white border-t border-gray-200 h-16">
            <Link className="" href={"/"}>
              <svg
